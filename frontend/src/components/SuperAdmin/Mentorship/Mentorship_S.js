...
function Mentorship_S() {
    ...
    useEffect(() => {
        async function fetchUserInfo() {
            try {
                const response = await fetch('http://localhost:8000/api/super/getMentorshipDetails');
    ...
    const handleDelete = async (id) => {
        try {
            const response = await fetch(`http://localhost:8000/api/super/deleteMentorshipData/${id}`, {
                method: 'DELETE',
            });
