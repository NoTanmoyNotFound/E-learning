...
const S_sidebar = ({ openSidebarToggle, OpenSidebar }) => {
    return (
        <aside id="sidebar" className={openSidebarToggle ? "sidebar-responsive" : ""}>
            <div className='sidebar-title'>
            
                <div className="profile">
                    <img src="s.png" className="image" id="pfp" alt="Profile" />
                    <h3 className="name">Saklin Mustak</h3>
                    <p className="role">Super Admin</p>
                </div>
                <span id='closeIcon' className='iconn close_iconn' onClick={OpenSidebar} style={{marginTop:"-6rem", color:"black"}}><i class="fa-solid fa-angle-left "></i></span>
            </div>
